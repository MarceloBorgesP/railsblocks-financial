...
require "railsblocks/financial/version"

# Describe your gem and declare its dependencies:
Gem::Specification.new do |s|
  s.name        = "railsblocks-financial"
  s.version     = Railsblocks::Financial::VERSION
  s.authors     = ["Celso Fernandes"]
  s.email       = ["fernandes@zertico.com"]
  s.homepage    = "http://domain.com"
  s.summary     = "Summary of Railsblocks::Financial."
  s.description = "Description of Railsblocks::Financial."
  s.license     = "MIT"
